      ...
      <div className={styles.pageContainer}>
        ...
        <section className={styles.imageSection}>
          ...
          <div className={styles.imageContent}>
            <h2 className={styles.subheading}>Transform Your Institution</h2>
            <p className={styles.description}>
              At Paradox Innovator, we provide comprehensive lab setup services for academic institutions to foster innovation and hands-on learning. Our labs are designed to empower students with the skills to work on cutting-edge technologies and develop real-world solutions.
            </p>
          </div>
        </section>
        ...
        <section className={styles.intro}>
          <p className={styles.description}>
            From IoT and automation to AI and renewable energy, we offer customized lab setups that align with your institution's vision and academic goals.
          </p>
        </section>
